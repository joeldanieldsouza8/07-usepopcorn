...
export default function App() {
  const [movies, setMovies] = useState(tempMovieData); // This state has been lifted up
  const [watched, setWatched] = useState(tempWatchedData); // This state has been lifted up
